...
Источники: выгрузки Бухгалтерия предприятия (платформы 8.3.24–8.3.27), ERP 2 (8.3.24).
...
| Аспект | `2.17` (8.3.24) | `2.18`–`2.21` (8.3.25–8.5) |
|---|---|---|
| Атрибут `version` | `2.17` | `2.18` / `2.19` / `2.20` / `2.21` по платформе |
...
> Структурных различий в формате подсистем и командного интерфейса между версиями не обнаружено ни на одном шаге лестницы. Меняется только атрибут `version` и наличие BOM.
